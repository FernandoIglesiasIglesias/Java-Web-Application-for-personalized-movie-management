...
public interface RatingService {
     ...
     * @throws InstanceNotFoundException if the user or movie doesn't exist
     */
    Rating getUserRatingForMovie(Long userId, Long movieId) 
     ...
     * @throws InstanceNotFoundException if the movie doesn't exist
     */
    List<Rating> getMovieRatings(Long movieId) throws InstanceNotFoundException;
     ...
     */
    void deleteRating(Long userId, Long movieId) throws InstanceNotFoundException;
}